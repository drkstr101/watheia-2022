...
import {
  ...
  recentPosts,
  solutions,
} from './home-view.fixtures';
import { HomeViewProps } from './home-view.types';
    ...
    <header className="relative isolate z-10">
      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover>
            <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-neutral-900">
              Solutions
              <ChevronDownIcon
            ...
            >
              <Popover.Panel className="absolute inset-x-0 top-0 -z-10 bg-white pt-14 shadow-lg ring-1 ring-neutral-900/5">
                <div className="mx-auto grid max-w-7xl grid-cols-4 gap-x-4 px-6 py-10 lg:px-8 xl:gap-x-8">
                  {solutions.map((item) => (
                    <div
                      key={item.name}
                      className="group relative rounded-lg p-6 text-sm leading-6 hover:bg-neutral-50"
                    >
                      <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-neutral-50 group-hover:bg-white">
                        <item.icon
                      ...
                      <Link
                        href={item.href}
                        className="mt-6 block font-semibold text-neutral-900"
                      >
                        {item.name}
                ...
                <div className="bg-neutral-50">
                  <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid grid-cols-3 divide-x divide-neutral-900/5 border-x border-neutral-900/5">
                      {callsToAction.map((item) => (
                        <Link
                          key={item.name}
                          href={item.href}
                          className="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-neutral-900 hover:bg-neutral-100"
                        >
                          <item.icon
                            className="h-5 w-5 flex-none text-neutral-400"
                            aria-hidden="true"
          ...
          <Link href="#" className="text-sm font-semibold leading-6 text-neutral-900">
            Demo
          </Link>
          <Link href="#" className="text-sm font-semibold leading-6 text-neutral-900">
            Blog
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link href="/signin" className="text-sm font-semibold leading-6 text-neutral-900">
            ...
            <div className="-my-6 divide-y divide-neutral-500/10">
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  {({ open }: { open: boolean }) => (
                    <>
                      <Disclosure.Button className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-neutral-900 hover:bg-neutral-50">
                        Solutions
                        <ChevronDownIcon
      ...
      <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
        <div className="flex">
          <div className="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-neutral-600 ring-1 ring-neutral-900/10 hover:ring-neutral-900/20">
            <span className="font-semibold text-primary-600">Hire us!</span>
            <span className="h-4 w-px bg-neutral-900/10" aria-hidden="true" />
            <Link href="#" className="flex items-center gap-x-1">
              <span className="absolute inset-0" aria-hidden="true" />
              Get free consultation
              <ChevronRightIcon className="-mr-2 h-5 w-5 text-neutral-400" aria-hidden="true" />
            </Link>
          </div>
        </div>
...
const Highlights = () => (
  <Container className="pb-16 pt-20 sm:pb-24 sm:pt-32">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
        <div className="lg:row-start-2 lg:max-w-md">
          ...
          <p className="mt-6 text-lg leading-8 text-neutral-300">
            ...
            sagittis vel nulla. Ac euismod vel sit maecenas.
          </p>
        </div>
        <img
...
const Features = () => (
  <div className="border-t border-b border-neutral-200 bg-neutral-100 py-20 sm:py-32">
    <Container>
...
const Testimonials = () => (
  <div className="relative isolate mt-32 sm:mt-56 sm:pt-32">
    <svg
      className="absolute inset-0 -z-10 hidden h-full w-full stroke-neutral-200 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)] sm:block"
      aria-hidden="true"
    >
      <defs>
        <pattern
      ...
      <svg x="50%" y={0} className="overflow-visible fill-neutral-50">
        <path
          ...
          <figure className="col-span-2 hidden sm:block sm:rounded-2xl sm:bg-white sm:shadow-lg sm:ring-1 sm:ring-neutral-900/5 xl:col-start-2 xl:row-end-1">
            ...
            <figcaption className="flex items-center gap-x-4 border-t border-neutral-900/10 px-6 py-4">
              ...
              <div className="flex-auto">
                ...
                <div className="text-neutral-600">{`@${featuredPost.author.handle}`}</div>
              </div>
              <img className="h-10 w-auto flex-none" src={featuredPost.author.logoUrl} alt="" />
            </figcaption>
          </figure>
          {recentPosts.map((columnGroup, columnGroupIdx) => (
                ...
                <div
                  ...
                  className={clsx(
                    (columnGroupIdx === 0 && columnIdx === 0) ||
                      (columnGroupIdx === recentPosts.length - 1 &&
...
const Footer = () => (
  <footer className="mt-32 bg-neutral-900 sm:mt-56" aria-labelledby="footer-heading">
        ...
        <div className="flex space-x-6 md:order-2">
          {footerNavigation.social.map((item) => (
            ...
            >
              ...
              <SocialIcon variant={item.name} className="h-6 w-6" aria-hidden="true" />
            </Link>
          ))}
        </div>
...
export function HomeView({ featuredPost, recentPosts, ...props }: HomeViewProps) {
  return (
    <article {...props}>
      <Header />
      <main>
