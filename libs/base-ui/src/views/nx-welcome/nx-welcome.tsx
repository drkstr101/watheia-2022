...
export const __cid__ = (NxWelcome.__cid__ = '@watheia/base-ui.views.nx-welcome');

export interface NxWelcomeProps extends HtmlHTMLAttributes<HTMLDivElement> {
  title: string;
}

export function NxWelcome({ title, ...props }: NxWelcomeProps) {
  return (
    <div data-testid={__cid__} {...props}>
      <style
