        ...
        {msgs.length > 0 ? (
            ...
            <div key={m.id} className="flex items-start w-full mb-5 relative">
              ...
              <div className="flex flex-col flex-grow">
                <div className="w-full flex  items-center font-medium pl-2">
                  ...
                  {m.senderRole === 'course' || m.senderRole === 'backstage' ? (
                    <Badge
                ...
                <div className="pl-2 text-gray-200 break-words w-[220px] mt-1">
                  {m.message}
                </div>
              </div>
              {localPeer.roleName === 'course' ||
          ...
          <div className="h-full flex justify-center items-center">
            <div className="w-full flex flex-col items-center text-center">
              ...
              <p>
                Welcome to the Webinar. You can engage with the instructor and
