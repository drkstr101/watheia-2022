    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          value: 'small-list',
          thumbnail:
            'https://assets.stackbit.com/components/images/default/small-list.png',
        },
        {
          label: 'Big list',
          value: 'big-list',
          thumbnail:
            'https://assets.stackbit.com/components/images/default/big-list.png',
        },
        {
          label: 'Toggle list',
          value: 'toggle-list',
          thumbnail:
            'https://assets.stackbit.com/components/images/default/toggle-list.png',
        },
      ],
      group: 'styles',
