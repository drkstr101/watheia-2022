...
import {
  useVariantChoicesContext,
  ninetailedEnabled,
} from '../../utils/ninetailed-helpers';
...
const withPersonalization =
  ...
  ({ ...baselineProps }) => {
    ...
    const userSelectedVarId =
      choices[baselineProps.__metadata.id] || PERSONALIZED_VARIANT_ID;

    const currentVariant =
      userSelectedVarId === PERSONALIZED_VARIANT_ID
        ? personalizedVariant
        : variantsWithBaseline.find(
            (v) => v.__metadata.id === userSelectedVarId
          ) || personalizedVariant;
