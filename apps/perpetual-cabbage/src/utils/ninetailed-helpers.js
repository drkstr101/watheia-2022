...
export const ninetailedApiKey =
  process.env.NEXT_PUBLIC_NINETAILED_API_KEY || null;
export const ninetailedEnvironment =
  process.env.NEXT_PUBLIC_NINETAILED_ENVIRONMENT || null;
