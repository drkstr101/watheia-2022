    ...
    >
      <Container>
        ...
        <p className="mt-4 text-lg tracking-tight text-slate-700">
          “Everything Starts as a Square” is comprised of 240 tightly edited, highly visual
          pages designed to teach you everything you need to know about icon design with no
          unnecessary filler.
        </p>
        <Expandable>
          {({ isExpanded }) => (
                      ...
                      >
                        {Object.entries(pages).map(([title, pageNumber]) => (
                          ...
                          >
                            ...
                            <span className="font-mono text-slate-400" aria-hidden="true">
                              {pageNumber}
                            </span>
                          </li>
                        ))}
