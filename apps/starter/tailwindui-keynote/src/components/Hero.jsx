        ...
        <div className="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
          ...
          <div className="font-display mt-6 space-y-6 text-2xl tracking-tight text-blue-900">
            <p>
              ...
              certainly aren’t accepting any checks from Western Union.
            </p>
            <p>
              At DeceptiConf you’ll learn about the latest dark patterns being developed to
              trick even the smartest visitors, and you’ll learn how to deploy them without ever
              being detected.
            </p>
          </div>
