...
type SocialVariant = 'Facebook' | 'Instagram' | 'Twitter' | 'GitHub' | 'YouTube';

const SocialIcon = ({
  variant,
  ...props
}: SVGProps<SVGSVGElement> & { variant: SocialVariant }): JSX.Element | null => {
  switch (variant) {
    case 'Facebook':
...
const Newsletter = () => (
  <Container className="mt-32 sm:mt-56 sm:px-6 lg:px-8">
