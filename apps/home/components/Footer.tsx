      ...
      <Container>
        <div className="flex flex-col items-start justify-between gap-y-12 pb-6 pt-16 lg:flex-row lg:items-center lg:py-16">
          <div>
            <div className="flex items-center text-neutral-900">
              <Logomark className="h-10 w-10 flex-none fill-accent-500" />
              <div className="ml-4">
                <p className="text-base font-semibold">Watheia Labs</p>
                <p className="mt-1 text-sm">We make technology easy.</p>
              </div>
            </div>
          ...
          <div className="group relative -mx-4 flex items-center self-stretch p-4 transition-colors hover:bg-neutral-100 sm:self-auto sm:rounded-2xl lg:mx-0 lg:self-auto lg:p-6">
            <div className="relative flex h-24 w-24 flex-none items-center justify-center">
              <QrCodeBorder className="absolute inset-0 h-full w-full stroke-neutral-300 transition-colors group-hover:stroke-accent-500" />
        ...
        <div className="flex flex-col items-center border-t border-neutral-200 pb-12 pt-8 md:flex-row-reverse md:justify-between md:pt-6">
          <form className="flex w-full justify-center md:w-auto">
            ...
            />
            <Button type="submit" color="accent" className="ml-4 flex-none">
