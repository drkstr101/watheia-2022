...
const prices = [
  ...
  694.03, 610.1, 502.2, 549.56, 611.03, 583.4, 610.14, 660.6, 752.11, 721.19, 638.89, 661.7,
  694.51, 580.3, 638.0, 613.3, 651.64, 560.51, 611.45, 670.68, 752.56,
];
...
function Chart({
  ...
  for (let index = 0; index < prices.length; index++) {
    ...
    const y = paddingY + (1 - (prices[index] - minPrice) / (maxPrice - minPrice)) * height;
    points.push({ x, y });
      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-xs leading-6 text-neutral-500">Tailwind Labs, Inc.</div>
            <div className="text-sm text-neutral-900">$CSS</div>
          ...
          <div className="mt-3 border-t border-neutral-200 pt-5">
            <div className="flex items-baseline gap-2">
              ...
              <div className="text-sm text-neutral-900">USD</div>
              {percentageChange && (
                <div
                  className={clsx(
                    'ml-auto text-sm tabular-nums tracking-tight',
                    percentageChange >= 0 ? 'text-accent-500' : 'text-neutral-500'
                  )}
                >
            ...
            <div className="mt-6 flex gap-4 text-xs text-neutral-500">
              <div>1D</div>
              <div>5D</div>
              <div className="font-semibold text-accent-600">1M</div>
              <div>6M</div>
              <div>1Y</div>
              <div>5Y</div>
            </div>
            ...
            <div className="mt-4 rounded-lg bg-accent-500 px-4 py-2 text-center text-sm font-semibold text-white">
              Trade
            </div>
