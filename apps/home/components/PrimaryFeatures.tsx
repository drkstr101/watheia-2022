...
const features = [
  {
    ...
    description:
      "For every friend you invite to Watheia, you get insider notifications 5 seconds sooner. And it's 10 seconds if you invite an insider.",
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    ...
    <AppScreen className="w-full">
      ...
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
        <div className="px-4 py-6">
          ...
          <div className="mt-6 rounded-lg bg-accent-500 px-3 py-2 text-center text-sm font-semibold text-white">
            Invite person
          </div>
        </div>
      </MotionAppScreenBody>
        ...
        <div className="divide-y divide-neutral-100">
          {[
            ...
            <div key={stock.name} className="flex items-center gap-4 px-4 py-3">
              ...
              <div className="flex-auto text-sm text-neutral-900">{stock.name}</div>
              <div className="flex-none text-right">
                <div className="text-sm font-medium text-neutral-900">{stock.price}</div>
                <div
                  className={clsx(
                    'text-xs leading-5',
                    stock.change.startsWith('+') ? 'text-accent-500' : 'text-neutral-500'
                  )}
                >
                  {stock.change}
                </div>
      ...
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
        <div className="px-4 py-6">
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-accent-500 px-3 py-2 text-center text-sm font-semibold text-white">
              Buy shares
            </div>
          </div>
        </div>
...
function FeaturesMobile() {
  ...
  return (
    <>
      ...
      >
        {features.map((feature: any, featureIndex) => (
          <div
            key={featureIndex}
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          <p className="mt-2 text-lg text-neutral-400">
            Watheia was built for investors like you who play by their own rules and aren’t
            going to let SEC regulations get in the way of their dreams. If other investing
            tools are afraid to build it, Watheia has it.
          </p>
        </div>
      </Container>
