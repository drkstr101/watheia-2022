...
const plans = [
  ...
  },
  {
    ...
    logomarkClassName: 'fill-accent-500',
  },
];
...
function Plan({
  ...
  return (
    ...
    >
      ...
      <p className={clsx('mt-3 text-sm', featured ? 'text-neutral-300' : 'text-neutral-700')}>
        {description}
      </p>
        ...
        <div className="mt-8 flex justify-center">
          <div className="relative">
            ...
            <div
              aria-hidden="true"
              className={clsx(
                'pointer-events-none absolute inset-0 z-10 grid grid-cols-2 overflow-hidden rounded-lg bg-accent-500 transition-all duration-300',
                activePeriod === 'Monthly'
