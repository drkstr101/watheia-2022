          ...
          <div className="flex items-center gap-6">
            <Popover className="lg:hidden">
              {({ open }) => (
                <>
                  <Popover.Button
                    className="relative z-10 -m-2 inline-flex items-center rounded-lg stroke-neutral-900 p-2 hover:bg-neutral-200/50 hover:stroke-neutral-600 active:stroke-neutral-900 [&:not(:focus-visible)]:focus:outline-none"
