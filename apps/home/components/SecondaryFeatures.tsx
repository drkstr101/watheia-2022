...
const features = [
  ...
  },
  {
    ...
    description: 'Invite new insiders to get tips faster and beat even other Watheia users.',
    icon: DeviceListIcon,
  },
  {
      ...
      <Container>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-2 text-lg text-neutral-600">
            ...
            Watheia, it’s never too late to build your nest egg.
          </p>
        </div>
        <ul
          role="list"
        ...
        >
          {features.map((feature) => (
            <li key={feature.name} className="rounded-2xl border border-neutral-200 p-8">
              <feature.icon className="h-8 w-8" />
              <h3 className="mt-6 font-semibold text-neutral-900">{feature.name}</h3>
